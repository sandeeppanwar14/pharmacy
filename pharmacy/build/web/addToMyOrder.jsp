<%-- 
    Document   : addToMyOrder
    Created on : Jul 4, 2018, 12:02:38 PM
    Author     : sandeep
--%>
...
<div class="topnav" id="myTopnav">
    ...
    <i class="fa fa-bars"></i>
            ...
            <div class="modal">
  <form class="modal-content" action="addToOrder" method="post">
    <div class="container">
      <h1>Add To My Order</h1>
      <p>Please provide the order no. to be added.</p>
