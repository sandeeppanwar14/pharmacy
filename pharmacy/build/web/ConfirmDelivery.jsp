<%-- 
    Document   : ConfirmDelivery
    Created on : Jul 4, 2018, 12:56:36 PM
    Author     : sandeep
--%>
...
<div class="topnav" id="myTopnav">
    ...
    <i class="fa fa-bars"></i>
            ...
            <div class="modal">
  <form class="modal-content" action="ConfirmDelivery" method="post">
    <div class="container">
      <h1>Confirm Delivery</h1>
      <p>Please provide the order no. of the delivered order.</p>
